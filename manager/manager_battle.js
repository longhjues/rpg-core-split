...
BattleManager.setup = function (troopId, canEscape, canLose) {
    ...
    this.makeEscapeRatio(); // 计算逃跑成功率
};

// 初始化战斗
BattleManager.initMembers = function () {
    this._phase = 'init'; // 阶段
    this._canEscape = false; // 是否能逃跑
    this._canLose = false; // 是否能失败
    ...
    this._mapBgm = null;
    this._mapBgs = null;
    this._actionBattlers = []; // 战斗单位行动顺序表
    this._subject = null;
    this._action = null;
    this._targets = [];
